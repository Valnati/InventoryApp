...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Setup the item click listener for individual list items
    ...
    private void insertBook() {
        ...
        // and this book's attributes are the values.
        ContentValues values = new ContentValues();
        values.put(BookEntry.COLUMN_BOOK_NAME, "So You Want to be a Wizard");
        values.put(BookEntry.COLUMN_BOOK_PRICE, 1499);
        values.put(BookEntry.COLUMN_BOOK_QUANTITY, 6);
        values.put(BookEntry.COLUMN_BOOK_SUPPLIER, "Tale Corner");
        values.put(BookEntry.COLUMN_BOOK_PHONE, "2345678900");
